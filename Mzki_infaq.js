...
<View style={styles.container}>
    ...
    <TouchableOpacity onPress={() => navigation.navigate('Mzki_infaqcnf')} style={styles.button}><Text style={{fontWeight: 'bold'}}>Konfirmasi</Text></TouchableOpacity>
</View>
);
};

export default Mzki_infaq;