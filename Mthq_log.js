...
const Mthq_log = ({navigation}) => {
    return (
        ...
        <Text style={styles.Text}>NPPZ</Text>
        <TextInput keyboardType='numeric' maxLength={15} placeholder="Masukkan NPPZ.." style={styles.Input} />
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Mthq_main')} style = {styles.button}><Text style={{fontWeight:'bold'}}>MASUK</Text></TouchableOpacity>
        </View>
        </KeyboardAvoidingView>
    );
};

export default Mthq_log