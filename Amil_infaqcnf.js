...
const Amil_infaqcnf = ({navigation}) => {
    return(
<View style={styles.container}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Amil_main')} style={{backgroundColor: '#95C2D3', borderRadius:10, borderWidth: 1,padding: 10, alignSelf: 'center',alignItems: 'center',marginTop:'10%',width:'55%',height:'6%'}}><Text style={{fontWeight: 'bold'}}>Dashboard</Text></TouchableOpacity>
