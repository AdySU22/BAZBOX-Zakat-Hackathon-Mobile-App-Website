...
const Amil_veriffinal = ({navigation}) => {
    return(
<View style={styles.container}>
        ...
        <Text style={{fontSize: 24, textAlign: 'center',marginTop: '50%'}}>Selamat!{'\n'}Verifikasi anda berhasil!</Text>
...
export default Amil_veriffinal;