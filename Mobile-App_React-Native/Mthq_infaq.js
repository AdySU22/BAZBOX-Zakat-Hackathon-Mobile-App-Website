...
<View style={styles.container}>
    ...
    <TouchableOpacity onPress={() => navigation.navigate('Mthq_infaqcnf')} style={styles.button}><Text style={{fontWeight: 'bold'}}>Konfirmasi</Text></TouchableOpacity>
</View>
);
};

export default Mthq_infaq;