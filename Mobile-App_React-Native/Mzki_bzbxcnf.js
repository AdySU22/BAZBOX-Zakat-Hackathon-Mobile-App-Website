...
<View style={styles.container}>
        ...
        <Text style={{fontSize: 18, textAlign: 'center',backgroundColor: '#D9D9D9',width:'60%',borderRadius: 10,alignSelf: 'center'}}>Terkirim/Belum Terkirim</Text>
        <TouchableOpacity onPress={() => navigation.navigate('Mzki_bzbxfinal')} style={{backgroundColor: '#95C2D3', borderRadius:10, borderWidth: 1,padding: 10, alignSelf: 'center',alignItems: 'center',marginTop:'10%',width:'55%',height:'7%'}}><Text style={{fontWeight: 'bold'}}>Selanjutnya</Text></TouchableOpacity>
