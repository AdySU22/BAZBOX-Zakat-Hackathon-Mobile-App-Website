...
const Amil_log = ({navigation}) => {
    return (
        ...
        <TextInput keyboardType='numeric' maxLength={15} placeholder="Masukkan ID.." style={styles.Input} />
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Amil_main')} style = {styles.button}><Text style={{fontWeight:'bold'}}>MASUK</Text></TouchableOpacity>
        </View>
        </KeyboardAvoidingView>
    );
};

export default Amil_log